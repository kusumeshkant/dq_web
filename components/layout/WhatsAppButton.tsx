...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-6 right-6 z-50 flex items-center gap-2 bg-[#25D366] text-white px-4 py-3 rounded-full shadow-lg hover:bg-[#1ebe5d] hover:shadow-xl transition-all duration-200 group"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
