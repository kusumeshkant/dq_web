  ...
  return (
    <a
      ...
      className="
        ...
        overflow-hidden
        bg-[#25D366]/80 backdrop-blur-md
        text-white
        pl-4 pr-5 py-3 rounded-full
        border border-white/25
        shadow-[0_8px_32px_rgba(37,211,102,0.38),0_2px_8px_rgba(0,0,0,0.14)]
        hover:bg-[#25D366]/95
        hover:shadow-[0_12px_44px_rgba(37,211,102,0.55),0_4px_16px_rgba(0,0,0,0.18)]
        hover:scale-105
        active:scale-95
        transition-all duration-300
      "
    >
      {/* Inner glass sheen — light hitting top of pill */}
      <div
        className="absolute inset-0 bg-gradient-to-b from-white/[0.18] via-transparent to-black/[0.06] pointer-events-none"
        aria-hidden="true"
      />
