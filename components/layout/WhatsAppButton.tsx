...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed bottom-20 right-4 lg:bottom-6 lg:right-6 z-50 flex items-center gap-2.5 bg-[#25D366] text-white pl-4 pr-5 py-3 rounded-full shadow-lg hover:shadow-xl hover:bg-[#1ebe5d] hover:scale-105 active:scale-95 transition-all duration-200"
    >
      <svg
        viewBox="0 0 24 24"
        fill="currentColor"
